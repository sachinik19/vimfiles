...
" Remove underline from cursorline
highlight CursorLine term=NONE cterm=NONE ctermbg=0 guibg=#333333
" --------------------
" TagList
" --------------------
...
"To auto exit NERDTree on vim exit. 
autocmd bufenter * if (winnr("$") == 1 && exists("b:NERDTreeType") && b:NERDTreeType == "primary") | q | endif

autocmd VimEnter * NERDTree     " To auto open NERDTree on vim start
autocmd VimEnter * wincmd p     " To keep focus on vim window on start
let g:NERDTreeWinPos = "right"  " To open NERDTree on right side
